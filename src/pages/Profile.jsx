...
const Profile = () => {
  ...
  const badges = [
    { id: 1, name: 'Green Thumb', description: 'Planted 50+ crops', icon: 'GT', earned: true },
    { id: 2, name: 'Water Saver', description: 'Used drip irrigation', icon: 'WS', earned: true },
    { id: 3, name: 'Organic Master', description: 'No chemical pesticides for 30 days', icon: 'OM', earned: false },
    { id: 4, name: 'Harvest Hero', description: 'Harvested 100+ crops', icon: 'HH', earned: true },
    { id: 5, name: 'Eco Warrior', description: 'Sustainability score 90+', icon: 'EW', earned: false },
    { id: 6, name: 'Community Leader', description: 'Top 10 in leaderboard', icon: 'CL', earned: false },
  ];
  ...
  const sustainabilityBreakdown = [
    { practice: 'Organic Farming', score: 90, color: 'primary' },
    { practice: 'Water Conservation', score: 85, color: 'sky' },
    { practice: 'Soil Health', score: 80, color: 'accent' },
    { practice: 'Biodiversity', score: 88, color: 'primary' },
  ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin w-10 h-10 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="max-w-md mx-auto">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Location: {translateTaluk(profileData.taluk)}, {translateState(profileData.state)}
              </p>
              <ProgressBar 
